"""sync deployment table columns

Revision ID: 010_account_owner
Revises: 3154dee84a85
...
revision: str = '010_account_owner'
down_revision: Union[str, Sequence[str], None] = '3154dee84a85'
