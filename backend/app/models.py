...
class Deployment(Base):
    ...
    kickoff_status = Column(String, nullable=True)
    materials_status = Column(String, nullable=True)
    uat_fat_status = Column(String, nullable=True)
    stage_statuses = Column(JSONB, nullable=True)
    kickoff_date = Column(DateTime, nullable=True)
    end_date = Column(DateTime, nullable=True)
    device_status = Column(String, nullable=True)
    collected = Column(Boolean, default=False, nullable=True)
    validated_by = Column(String, nullable=True)
    product_quantity = Column(Integer, default=1, nullable=True)
