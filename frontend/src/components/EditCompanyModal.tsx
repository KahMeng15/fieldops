...
import { updateCompany, getCompanyFieldSettings, type Company, type CompanyFieldsSettings } from '../api';
      ...
      getCompanyFieldSettings()
        .then(settings => {
          ...
          settings.fields
            ...
            .forEach(f => {
              initialCustom[f.key] = company[f.key] !== undefined && company[f.key] !== null ? String(company[f.key]) : (f.default_value || '');
            });
